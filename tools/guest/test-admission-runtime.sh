...
out=${1:?Usage: test-admission-runtime.sh OUTPUT_DIRECTORY [loadermodel|adcinputcontrol|adcinputmodel|adcsequencecontrol|adcsequencemodel]}
control_mode=${2:-loadermodel}
case "$control_mode" in loadermodel|adcinputcontrol|adcinputmodel|adcsequencecontrol|adcsequencemodel) ;; *) exit 2;; esac
