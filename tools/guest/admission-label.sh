...
if [ "${ADMISSION_MODE:-label}" = groupmodel ] || [ "${ADMISSION_MODE:-label}" = nextmodel ] || [ "${ADMISSION_MODE:-label}" = writemodel ] || [ "${ADMISSION_MODE:-label}" = pairmodel ] || [ "${ADMISSION_MODE:-label}" = transcriptmodel ] || [ "${ADMISSION_MODE:-label}" = spumodel ]; then
    native_rc=0
