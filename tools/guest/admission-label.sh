...
if [ "${ADMISSION_MODE:-label}" = groupmodel ] || [ "${ADMISSION_MODE:-label}" = nextmodel ] || [ "${ADMISSION_MODE:-label}" = writemodel ] || [ "${ADMISSION_MODE:-label}" = pairmodel ] || [ "${ADMISSION_MODE:-label}" = transcriptmodel ] || [ "${ADMISSION_MODE:-label}" = spumodel ] || [ "${ADMISSION_MODE:-label}" = remainingmodel ] || [ "${ADMISSION_MODE:-label}" = tailmodel ]; then
    native_rc=0
