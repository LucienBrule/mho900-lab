...
shasum -a 256 "$cc" "$ld" "$repo/tools/guest/group-observer.c" "$repo/tools/guest/thread-group.h" "$repo/tools/guest/native-probe.c" "$repo/tools/guest/native-post-store.h" "$repo/tools/guest/adc-transcript.h" "$repo/tools/guest/spu-transcript.h" "$repo/tools/guest/remaining-init.h" "$repo/tools/guest/init-tail.h" > "$out/build-inputs.txt"
